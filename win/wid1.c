 ...
 *		University.
 *******************************************************************************
 * $Date: 1994/10/19 21:17:50 $
 * $State: Exp $
 * $Locker:  $
 * $Source: /tmp_mnt/home/borg3/franklin/RCS/wid1.c,v $
 *
 **-M**************************************************************************/
 ...
 *
$Log: wid1.c,v $
 * Revision 1.75  1994/10/19  21:17:50  franklin
 * Use the -drawing_width and -drawing_height command line switches to set
 * the height and width of the virtual drawing window where the animation
 * is drawn.
 *
...
static char    *rcsid = "@(#) $Id: wid1.c,v 1.75 1994/10/19 21:17:50 franklin Exp $";
...
/* Handle   scrollbar     */
	...
	drawing_a = XtVaCreateManagedWidget ("drawing_a",
					     ...
					     XmNwidth, fetch_drawing_width(),
					     XmNheight, fetch_drawing_height(),
