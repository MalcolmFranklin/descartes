 ...
 * $State: Exp $
 * $Locker:  $
 * $Source: /all/franklin/thesis/descartes/win/cmdline_ex/RCS/fifo.c,v $
 *
 ******************************************************************************/
...
static char    *rcsid = "$Id: fifo.c,v 1.37 1994/08/22 00:22:28 franklin Exp $";
...
{
	printf ("destroy_child2parent( 0x%X ) called by PID %d line %d of %s\n", child2parent, getpid (), __LINE__, __FILE__);
	fflush (stdout);
	if (child2parent != NULL)
	{
