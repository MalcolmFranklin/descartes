 ...
 * email.
 ***********************************************************
 * $Date: 1994/10/17 05:40:55 $
 * $State: Exp $
 * $Locker:  $
 * $Source: /all/franklin/thesis/descartes/win/cmdline_ex/RCS/command_line.c,v $
 **********************************************************/
    static char    *rcsid = "$Id: command_line.c,v 1.11 1994/10/17 05:40:55 franklin Exp $";
