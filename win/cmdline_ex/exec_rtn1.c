 ...
 *
 *******************************************************************************
 * $Date: 1994/08/11 23:26:14 $
 * $State: Exp $
 * $Locker:  $
 * $Source: /all/franklin/thesis/descartes/win/cmdline_ex/RCS/exec_rtn1.c,v $
 *
 **-M**************************************************************************/
 ...
 *
$Log: exec_rtn1.c,v $
 * Revision 1.68  1994/08/11  23:26:14  franklin
 * Do not register a signal handler for SIGCHLD (was sigchild_handler()).
 *
...
static char    *rcsid = "@(#) $Id: exec_rtn1.c,v 1.68, h4_3_8, h4_3_7 1994/08/11 23:26:14 franklin Exp $";
...
static void     clientXDrawString (int x, int y, char *nodename, int length)
{
	...
	printf ("In clientXDrawString() buf == \"%s\"\n", buf);
	fflush (stdout);
