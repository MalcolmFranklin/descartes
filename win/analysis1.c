 ...
 ******************************************************************************/
#endif
static char    *rcsid = "@(#) $Id: analysis1.c,v 1.65, h4_3_8 1994/08/21 00:58:25 franklin Exp franklin $";
...
destroy_child2parent (child2parent); /* Destroy the inherited data structures, and replace with your own. */
free (child2parent);
...
destroy_child2parent (child2parent); /* Destroy the sub-child specific data structures before exiting. */
free (child2parent);
