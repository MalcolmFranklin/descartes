 ...
 * $Author: franklin $
 *******************************************************************************
 * $Date: 1994/10/19 21:19:17 $
 * $State: Exp $
 * $Locker:  $
 * $Source: /tmp_mnt/home/borg3/franklin/RCS/main.c,v $
 *
 ******************************************************************************/
 ...
 *
$Log: main.c,v $
 * Revision 1.31  1994/10/19  21:19:17  franklin
 * Make the height and width of the virtual window for the automation, a
...
static char    *rcsid = "$Id: main.c,v 1.31 1994/10/19 21:19:17 franklin Exp $";
...
static String   fallbacks[] = {
	...
	"!",
	"! Size of the animation window behind the scrolled window.",
	"Descartes.drawing_width:	1280",
	"Descartes.drawing_height:      1500",
	"!",
