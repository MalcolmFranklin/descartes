/* @(#) fbio.h 1.2@(#) Solbourne id 11/17/93 09:21:07 */
/*	@(#)fbio.h 1.3 90/12/05 SMI	*/
...
#ifdef	solbourne
/* get Solbourne-specific frame buffer type */
#define FBIOSOLBOURNE	_IOR(F, 50, int)
#endif	solbourne
...
#ifdef	solbourne
#define FBTYPE_SOLSGA		20	/* Solbourne SGA graphics */
...
#ifdef	solbourne
/* frame buffer resolution possibilities */
#define		FBRES_1152x900		1
#define		FBRES_1600x1280		2
#define		FBRES_1024x1024		3

/* Solbourne-specific frame buffer type codes (see FBIOSOLBOURNE above) */
#define	FBTYPE_SB_CG3		100
#endif	solbourne
#endif	/*!_kap_fbio_h*/
