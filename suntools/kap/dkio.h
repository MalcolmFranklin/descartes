/* @(#) dkio.h 1.1@(#) Solbourne id 9/22/93 00:03:15 */
/*
...
#define	DKC_XD753	DKC_XD7053	/* Solbourne */
#define	DKC_XD753_SMD	DKC_XD7053	/* Solbourne */
...
#define DKC_INTEL82077	19	/* floppy ctlr on campus2 */
/* Solbourne specific devices ... */
#define	DKC_RF3500	30
#define	DKC_IOASIC	31
#define	DKC_XD753_IPI	32
#define	DKC_VSCSI	33

/* ASCII table of controller types used by dkinfo ... */
#define DKC_ASCII_UNKNOWN	"Unknown"
#define DKC_ASCII_UNKNOWN_2	DKC_ASCII_UNKNOWN, DKC_ASCII_UNKNOWN
#define DKC_ASCII_UNKNOWN_4	DKC_ASCII_UNKNOWN_2, DKC_ASCII_UNKNOWN_2
#define DKC_ASCII_UNKNOWN_8	DKC_ASCII_UNKNOWN_4, DKC_ASCII_UNKNOWN_4
#define DKC_ASCII					\
    {							\
...
#define	DKI_SEQOPT	0x1000	/* optimized for sequential operations */
...
#ifdef	solbourne
	unsigned short	dkg_extra[6];	/* for compatible expansion */
	unsigned short	dkg_secsize;	/* # data bytes / sector */
#else	solbourne
...
#ifdef	solbourne
/*
 * Used for disk dma excersize
 */
struct dk_dma {
	int	dma_cnt;		/* transfer count */
	int	dma_src;		/* src address */
	int	dma_dst;		/* dst address */
};
#endif	solbourne
...
#ifdef	solbourne
#define	DKIOCDMA	_IOW(d, 127, struct dk_dma)	/* controller dma */
#endif	solbourne
...
#define	DKIOCSTOP	_IO(d,  150)			/* Stop drive */
#define	DKIOCSUSP	_IOWR(d,  151, int)		/* suspend/resume controller operations */
#define	DKIOCCFWUPD	_IOW(d,  152, char *)		/* update controller firmware */
#define	DKIOCCSSN	_IOW(d,  153, char *)		/* update controller serial number */
#define	DKIOCHIPRI	_IOWR(d,  154, char *)		/* set device as high priority */
#endif	solbourne
#endif /*!_sun_dkio_h*/
