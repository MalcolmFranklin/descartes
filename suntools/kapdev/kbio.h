/* @(#) kbio.h 1.1@(#) Solbourne id 9/22/93 00:06:40 */
/*
 * Copyright 1988 Solbourne Computer, Inc.
 * All rights reserved.
 */

/*	@(#)kbio.h 1.22 88/08/19 SMI	*/
...
/*
 * Set flag indicating whether or not to disable keyboard abort sequence.
 */
#define	KIOCSABORT	_IOW(K, 0, int)

/*
 * Get flag indicating whether or not to disable keyboard abort sequence.
 */
#define	KIOCGABORT	_IOR(K, 1, int)

/*
 * Set flag indicating whether or not to enable extra keyboard keys.
 */
#define	KIOCSXKEYS	_IOW(K, 2, int)

/*
 * Get flag indicating whether or not to enable extra keyboard keys.
 */
#define	KIOCGXKEYS	_IOR(K, 3, int)
