/* @(#) xderr.h 1.1@(#) Solbourne id 9/22/93 00:09:32 */
/*
 * Copyright 1988 Solbourne Computer, Inc.
 * All rights reserved.
 */

/*      @(#)xderr.h 1.1 88/03/29 SMI   */
...
#define	XDE_DCER	0x26		/* double chain error */
...
#define	XDE_DMAT	0x44		/* VMEbus dma timeout */
...
#define	XDE_FDMA	0x4a		/* fatal VMEbus dma error */
#define	XDE_VMEB	0x4b		/* VMEbus error */
#define	XDE_ACAB	0x4d		/* atomic chain aborted error */
...
#define	XDE_FMT5	0xe5		/* MTest 5 Fail (VMEbus dma reg) */
...
#define	XDE_FCAC	0xf7		/* cache parity */
#define	XDE_FDLT	0xf8		/* data late */
#define	XDE_FDME	0xf9		/* DMA error */
#define	XDE_FHWE	0xfa		/* fatal hardware error */
#define	XDE_FFHW	0xfb		/* firmware detected hardware error */
#define	XDE_FSEL	0xfd		/* bad select in unit attention */
#define	XDE_FSTA	0xfe		/* bad status in unit attention */
#define	XDE_FDTO	0xff		/* drive timeout in unit attention */
...
XDE_DMAT, XD_ERTRY,     DK_NONMEDIA,    "VMEbus dma timeout",
...
XDE_RVER, XD_ERTRY,     DK_ISMEDIA,     "read verify error",
XDE_FDMA, XD_ERTRY,     DK_NONMEDIA,    "fatal VMEbus dma error",
...
XDE_FCAC, XD_ERFTL,	DK_NONMEDIA,	"fatal error: cache parity",
XDE_FDLT, XD_ERFTL,	DK_NONMEDIA,	"fatal error: data late",
XDE_FDME, XD_ERFTL,	DK_NONMEDIA,	"fatal error: DMA error",
XDE_FHWE, XD_ERFTL,	DK_NONMEDIA,	"fatal error: fatal hw error",
XDE_FFHW, XD_ERFTL,	DK_NONMEDIA,	"fatal error: fw detected hw error",
XDE_FSEL, XD_ERFTL,	DK_NONMEDIA,	"fatal error: bad sel unit attn",
XDE_FSTA, XD_ERFTL,	DK_NONMEDIA,	"fatal error: bad stat unit attn",
/* dont add XDE_FDTO, it conflicts with UNKN */
...
XDE_ISGL, XD_ERFTL,     DK_NONMEDIA,    "illegal scatter/gather length",	XDE_NSEC, XD_ERFTL,     DK_NONMEDIA,    "not enough sectors/track",
...
XDE_DCER, XD_ERFTL,	DK_NONMEDIA,	"double chain error",
XDE_ACAB, XD_ERFTL,	DK_NONMEDIA,	"atomic chain aborted error",
