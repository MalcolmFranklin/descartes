/* @(#) vuid_store.h 1.1@(#) Solbourne id 9/22/93 00:09:20 */
/*
 * Copyright 1990 Solbourne Computer, Inc.
 * All rights reserved.
 */
/*	@(#)vuid_store.h 1.5 88/08/19 SMI	*/
 ...
 * (vuid) state maintainence package (see ../kapdev/vuid_event.h for a
...
#ifndef _kapdev_vuid_store_h
#define _kapdev_vuid_store_h
