/*******************************************************************************
 * $Date: 1994/05/06 01:07:41 $
 * $State: Exp $
 * $Locker:  $
 * $Source: /all/franklin/thesis/descartes/editor/RCS/editor.h,v $
 *
 ******************************************************************************/
#if 0
/******************************************************************************
 *
$Log: editor.h,v $
 * Revision 1.1  1994/05/06  01:07:41  franklin
 * Initial revision
 *
 ******************************************************************************/
#endif
static char	*editor_h_rcsid = "@(#) $Id: editor.h,v 1.1 1994/05/06 01:07:41 franklin Exp $";
...
int		  selected_item,selected_edit_mode=state_append;
struct node	  *block_head = 0;
struct node	  *block_tail = 0;
